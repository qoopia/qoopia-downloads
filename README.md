...
[![Latest stable release](https://img.shields.io/github/v/release/qoopia/qoopia-downloads)](https://github.com/qoopia/qoopia-downloads/releases/latest)

Your own memory for agents, on your Mac or server.

**[Download the latest Qoopia](https://github.com/qoopia/qoopia-downloads/releases/latest)** · [Website](https://qoopia.ai) · [Installation guide and agent prompts](https://qoopia.ai/docs#agent-install) · [Open-source code](https://github.com/qoopia/qoopia-source)
...
The badge and download button follow the latest stable release. [RELEASE.json](RELEASE.json) records its verified version, schema and package source. Update this record with each release; the production release monitor checks it. Native iOS is a separate TestFlight beta: [availability and installation](https://qoopia.ai/mobile).
